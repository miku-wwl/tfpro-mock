...
Do not solve the entire lab automatically unless the user explicitly asks
...
Do not modify Terraform files unless the user explicitly asks you to make
...
Do not destroy, replace, or recreate existing infrastructure without first

showing the plan and receiving explicit confirmation.
