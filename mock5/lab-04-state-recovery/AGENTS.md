...
Before executing any command that may delete a remote resource, stop and explain the risk. A state-only removal must be distinguished clearly from remote deletion.
